...
public class MiddleGapBoxParticleWritter extends AppendFileParticlesWriter {
  ...
  public MiddleGapBoxParticleWritter(final String fileName, final double boxWidth,
